...
class TaskListScreenState extends State<TaskListScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildTaskItem(BuildContext context, int index) {
    ...
    if (task.isDeleting) {
      ...
      bgColor = index % 2 == 0 ? Colors.purple.shade100 : Colors.white;
    }
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                // Alternar entre as cores com base no índice
                final backgroundColor = index % 2 == 0 
                    ? Colors.grey[200] // Cor para índices pares
                    : Colors.white;    // Cor para índices ímpares
              ...
              children: [
                ...
                IconButton(
                  icon: Icon(
                    ...
                    color: _isSending ? Colors.purple.shade100 : Colors.purple.shade300,
                  ),
